...
###### paveiksleliai tvarkomi per 3 vietas: root - kur saugo failus,
...
SECRET_KEY = '^@3cw&90(j#r$7kcw%zy^cn2sm@enpiry&7dsp^9s1jo9m8sey'
...
# pasted from Django > Heroku tut:

# Parse database configuration from $DATABASE_URL
import dj_database_url
DATABASES['default'] =  dj_database_url.config(default='postgres://eimis:maxmaxkit@localhost/blogdb')
